<template>
  <nav
    class="navbar navbar-expand-lg navbar-dark navbar-shrink nav-fill sticky-top justify-content-center"
    id="mainNav"
  >
    <button
